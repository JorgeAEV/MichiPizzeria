...
exports.reseñasController = void 0;
const database_1 = __importDefault(require("../database")); //acceso a la base de datos
class ReseñasController {
    mostrar_todos_reseñas(req, res) {
...
exports.reseñasController = new ReseñasController();
